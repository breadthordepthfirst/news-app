  ...
  Widget build(BuildContext context) {
    return GridView.builder(
        ...
        itemBuilder: (builderContext, articleIdx) {
          ...
          print(
              'Author: ${newsArticle['author']}, Description: ${newsArticle['description']}, newsItemUrl: ${newsArticle['url']}, imageUrl: ${newsArticle['urlToImage']}, publishedAt: ${newsArticle['publishedAt']}, sourceName: ${newsArticle['source']['name']}, title: ${newsArticle['title']}');

          return NewsGridItem(
            author: newsArticle['author'],
            description: newsArticle['description'] ?? newsArticle['content'],
            newsItemUrl: newsArticle['url'],
